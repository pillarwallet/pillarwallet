...
export type SyntheticsReducerAction = {
  type: string,
  payload: any,
};
...
export default function appSettingsReducer(
  state: SyntheticsReducerState = initialState,
  action: SyntheticsReducerAction,
) {
  switch (action.type) {
    case SET_SYNTHETIC_ASSETS_FETCHING:
      return {
        ...this.state,
        isFetching: action.payload,
      };
    case SET_AVAILABLE_SYNTHETIC_ASSETS:
      return {
        ...this.state,
        data: action.payload,
        isFetching: false,
