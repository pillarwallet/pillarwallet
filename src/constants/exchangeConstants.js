...
export const SET_SHAPESHIFT_ACCESS_TOKEN = 'SET_SHAPESHIFT_ACCESS_TOKEN';
...
export const CONNECT_TO_EXCHANGE = 'CONNECT_TO_EXCHANGE';
export const DISCONNECT_FROM_EXCHANGE = 'DISCONNECT_FROM_EXCHANGE';
export const SET_CONNECTED_EXCHANGES = 'SET_CONNECTED_EXCHANGES';
