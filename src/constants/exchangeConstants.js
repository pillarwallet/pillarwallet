...
export const ADD_ACCOUNT_EXCHANGE_ALLOWANCE = 'ADD_ACCOUNT_EXCHANGE_ALLOWANCE';
export const UPDATE_ACCOUNT_EXCHANGE_ALLOWANCE = 'UPDATE_ACCOUNT_EXCHANGE_ALLOWANCE';
...
export const SET_WBTC_FEES = 'SET_WBTC_FEES';
export const SET_WBTC_PENDING_TRANSACTIONS = 'SET_WBTC_PENDING_TRANSACTIONS';
export const ADD_WBTC_PENDING_TRANSACTION = 'ADD_WBTC_PENDING_TRANSACTION';
export const ADD_WBTC_SETTLED_TRANSACTION = 'ADD_WBTC_SETTLED_TRANSACTION';
export const SET_WBTC_SETTLED_TRANSACTIONS = 'SET_WBTC_SETTLED_TRANSACTIONS';
