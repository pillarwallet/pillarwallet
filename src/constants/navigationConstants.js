...
export const SEND_COLLECTIBLE_FROM_CONTACT_FLOW = 'SEND_COLLECTIBLE_FROM_CONTACT_FLOW';
export const SEND_COLLECTIBLE_ASSETS = 'SEND_COLLECTIBLE_ASSETS';
...
export const WALLETCONNECT_SCAN_QRCODE_SCREEN = 'WALLETCONNECT_SCAN_QRCODE_SCREEN';
