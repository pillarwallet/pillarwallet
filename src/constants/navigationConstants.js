...
export const WALLETS_LIST = 'WALLETS_LIST';
export const WALLET_SETTINGS = 'WALLET_SETTINGS';

// MANAGE TANK FLOW
export const MANAGE_TANK_FLOW = 'MANAGE_TANK_FLOW';
...
// BITCOIN FLOW
export const BITCOIN_SCREEN = 'BITCOIN_SCREEN';
export const SEND_BITCOIN_ADDRESS = 'SEND_BITCOIN_ADDRESS';
