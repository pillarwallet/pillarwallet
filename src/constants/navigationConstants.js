...
export const ENALBE_BIOMETRICS_SCREEN = 'ENALBE_BIOMETRICS_SCREEN';
export const NEW_IMPORT_WALLET = 'NEW_IMPORT_WALLET';
...
export const MENU_SELECT_APPEARANCE = 'MENU_SELECT_APPEARANCE';
...
// BRIDGE
export const BRIDGE_FLOW = 'BRIDGE_FLOW';
export const BRIDGE_TAB = 'BRIDGE_TAB';

// NATIVE INTEGRATION
export const NI_SERVICES = 'NI_SERVICES';
export const NATIVE_INTEGRATION_FLOW = 'NATIVE_INTEGRATION_FLOW';
export const NI_INPUT_SERVICE = 'NI_INPUT_SERVICE';
export const NI_VIEW_SERVICE = 'NI_VIEW_SERVICE';
export const NI_TRANSACTION_COMPLETED = 'NI_TRANSACTION_COMPLETED';
export const NI_WARNING = 'NI_WARNING';

// PILLAR STAKING
export const PILLAR_STAKING_FLOW = 'PILLAR_STAKING_FLOW';
export const PLR_STAKING = 'PLR_STAKING';
export const PLR_STAKING_VALIDATOR = 'PLR_STAKING_VALIDATOR';
