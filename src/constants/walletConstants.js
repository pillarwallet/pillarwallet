...
export const WEB_RECOVERY_PORTAL = 'WEB_RECOVERY_PORTAL';
export const RESET_WALLET_IMPORT = 'RESET_WALLET_IMPORT';
export const UPDATE_WALLET_IMPORT_STATE = 'UPDATE_WALLET_IMPORT_STATE';
...
export const SET_USERNAME_CHECK_ERROR_MESSAGE = 'SET_USERNAME_CHECK_ERROR_MESSAGE';
