...
export const SET_KEY_BASED_WALLET_HAS_POSITIVE_BALANCE = 'SET_KEY_BASED_WALLET_HAS_POSITIVE_BALANCE';
export const SET_CREATING_KEY_BASED_ASSET_TRANSFER_TRANSACTIONS = 'SET_CREATING_KEY_BASED_ASSET_TRANSFER_TRANSACTIONS';
