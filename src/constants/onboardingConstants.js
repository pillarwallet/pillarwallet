...
export const SET_VIEWED_RECEIVE_TOKENS_WARNING = 'SET_VIEWED_RECEIVE_TOKENS_WARNING';
export const SET_FETCHING = 'SET_FETCHING';
export const SET_LOADING_MESSAGE = 'SET_LOADING_MESSAGE';
export const SET_BIOMETIC_STATUS = 'SET_BIOMETIC_STATUS';
export const SET_SOCIAL_LOGIN_STATUS = 'SET_SOCIAL_LOGIN_STATUS';
