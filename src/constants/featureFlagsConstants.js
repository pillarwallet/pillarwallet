...
export const FEATURE_FLAGS = {
  ...
  SMART_WALLET_ENABLED: 'SMART_WALLET_ENABLED',
};
export const INITIAL_FEATURE_FLAGS = {
  [FEATURE_FLAGS.PPN_ENABLED]: false,
  [FEATURE_FLAGS.SMART_WALLET_ENABLED]: false,
};
export const DEVELOPMENT_FEATURE_FLAGS = {
  [FEATURE_FLAGS.PPN_ENABLED]: true,
  [FEATURE_FLAGS.SMART_WALLET_ENABLED]: true,
};
