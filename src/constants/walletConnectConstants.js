...
export const WALLETCONNECT_TIMEOUT = 1000 * 30;
...
export const WALLETCONNECT_CLEAR_PENDING = 'WALLETCONNECT_CLEAR_PENDING';
...
export const EXCHANGE_KEY_EVENT = 'exchange_key';
...
export const EXCHANGE_KEY_ERROR = 'EXCHANGE_KEY_ERROR';
export const CONNECT_ERROR = 'CONNECT_ERROR';
export const DISCONNECT_ERROR = 'DISCONNECT_ERROR';
export const SESSION_KILLED_ERROR = 'SESSION_KILLED_ERROR';
export const SESSION_SUBSCRIBE_ERROR = 'SESSION_SUBSCRIBE_ERROR';
