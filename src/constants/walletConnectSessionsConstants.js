...
export const REMOVE_WALLETCONNECT_V2_SESSION = 'REMOVE_WALLETCONNECT_V2_SESSION';
export const SET_IS_INITIALIZING_WALLETCONNECT_SESSIONS = 'SET_IS_INITIALIZING_WALLETCONNECT_SESSIONS';
export const UPDATE_WALLETCONNECT_SESSION = 'UPDATE_WALLETCONNECT_SESSION';
export const ADD_WALLETCONNECT_V2_SESSION = 'ADD_WALLETCONNECT_V2_SESSION';
