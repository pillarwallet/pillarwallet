...
export const DISMISS_SMART_WALLET_UPGRADE = 'DISMISS_SMART_WALLET_UPGRADE';
...
export const SET_SMART_WALLET_LAST_SYNCED_HASH = 'SET_SMART_WALLET_LAST_SYNCED_HASH';
export const SET_SMART_WALLET_DEPLOYMENT_STARTED = 'SET_SMART_WALLET_DEPLOYMENT_STARTED';
...
export const SMART_ACCOUNT_ASSET_TRANSFER = 'SMART_ACCOUNT_ASSET_TRANSFER';
