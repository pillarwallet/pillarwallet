...
export const SMART_WALLET_ACCOUNT_DEVICE_ADDED = 'SMART_WALLET_ACCOUNT_DEVICE_ADDED';
export const SMART_WALLET_ACCOUNT_DEVICE_REMOVED = 'SMART_WALLET_ACCOUNT_DEVICE_REMOVED';
export const SET_SMART_WALLET_DEPLOYMENT_ESTIMATE = 'SET_SMART_WALLET_DEPLOYMENT_ESTIMATE';
export const SET_GETTING_SMART_WALLET_DEPLOYMENT_ESTIMATE = 'SET_GETTING_SMART_WALLET_DEPLOYMENT_ESTIMATE';
export const SET_CHECKING_SMART_WALLET_SESSION = 'SET_CHECKING_SMART_WALLET_SESSION';
