...
// Local
import FromAssetSelector from 'screens/Bridge/Exchange-CrossChain/FromAssetSelector';
import ToAssetSelector from 'screens/Bridge/Exchange-CrossChain/ToAssetSelector';
import OfferCard from 'screens/Bridge/Exchange-CrossChain/OfferCard';
import { useFromAssets, useToAssets, useOffersQuery, sortOffers } from 'screens/Bridge/Exchange-CrossChain/utils';

interface Props {
  fetchTitle: (val: string) => void;
}

function CrossChain({ fetchTitle }: Props) {
