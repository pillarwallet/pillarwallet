...
// constants
import { IMPORT_WALLET, RECOVERY_PORTAL_RECOVER_WALLET } from 'constants/navigationConstants';
...
const WalletRecoveryOptions = (props: Props) => {
  ...
  const recoveryOptions = [
    ...
    { title: 'Use Recovery Portal (for Smart Wallet only)', route: RECOVERY_PORTAL_RECOVER_WALLET },
  ];
