...
// Types
import type { CategoryBalance, ChainBalance, CategoryBalancesPerChain, CollectibleCountPerChain } from 'models/Home';
...
export function getTotalChainBalances(chains: CategoryBalancesPerChain): ChainBalance {
