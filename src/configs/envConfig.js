...
const envVars = {
  production: {
    ...
    TX_DETAILS_URL_OPTIMISM: 'https://optimistic.etherscan.io/tx/',
    TX_DETAILS_URL_ARBITRUM: 'https://arbiscan.io/tx/',
    ...
    PILLARX_ENDPOINT: 'https://pillarx.app/via-pillar-wallet',
    ...buildEnvironment,
    ...devOptions,
  },
  staging: {
    ENVIRONMENT: STAGING,
    TX_DETAILS_URL_ETHEREUM: 'https://goerli.etherscan.io/tx/',
    TX_DETAILS_URL_BINANCE: 'https://testnet.bscscan.com/tx/',
    ...
    PILLARX_ENDPOINT: 'https://staging.pillarx.app/via-pillar-wallet',
    ...buildEnvironment,
    ...devOptions,
  },
};
