...
const envVars = {
  production: {
    ...
    ARCHANOVA_MIGRATOR_CONTRACT_ADDRESS: '0xAF628C207513c5E51d894b3733056B8080634923',
    ...buildEnvironment,
    ...devOptions,
  },
  staging: {
    ...
    PRISMIC_ENDPOINT_URL: 'https://pillar-app.cdn.prismic.io/api/v2',
    ARCHANOVA_MIGRATOR_CONTRACT_ADDRESS: '0x2308697b9976921B463d0f42abA5A7e6f288E5C3',
    ...buildEnvironment,
    ...devOptions,
  },
};
