...
export function formatPercentValue(value: ?BigNumber) {
  ...
  return t('percentValue', { value: value.multipliedBy(100).precision(2).toFixed() });
}
...
export function formatPercentChange(value: ?BigNumber) {
  ...
  return value.gte(0)
    ? t('positivePercentValue', { value: value.multipliedBy(100).precision(2).toFixed() })
    : t('percentValue', { value: value.multipliedBy(100).precision(2).toFixed() });
}

export function formatFiatValue(value: ?BigNumber, currency?: string) {
