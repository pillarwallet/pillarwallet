...
test('Works with single item', () => {
  const item1: Item = { title: 'Item 1', iconSource: 1, onPress: jest.fn() };
...
test('Works with multiple items', () => {
  const item1: Item = { title: 'Item 1', iconSource: 1, onPress: jest.fn() };
  const item2: Item = { title: 'Item 2', iconSource: 2, onPress: jest.fn() };
  const item3: Item = { title: 'Item 3', iconSource: 3, onPress: jest.fn() };
