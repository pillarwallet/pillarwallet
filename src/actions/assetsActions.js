...
import { delay, noop, parseAmountToWei, uniqBy } from 'utils/common';
  ...
  return async (dispatch: Dispatch, getState: GetState) => {
    ...
    try {
      ...
      if (transactionDetails.tokenType === COLLECTIBLES) {
        ...
        const value = parseAmountToWei(transactionDetails.amount, transactionDetails.decimals);
    ...
    // send ERC20 token
      ...
      if (tokenTx.hash) {
        historyTx = buildHistoryTransaction({
          ...tokenTx,
          asset: symbol,
          value: parseAmountToWei(amount, decimals),
