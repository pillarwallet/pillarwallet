...
import { fetchTransactionsHistoryAction, patchHistorySentSignedTransactionsAction } from './historyActions';
  ...
  return async (dispatch: Dispatch, getState: GetState, api: SDKWrapper) => {
    ...
    try {
      ...
      if (userState === REGISTERED) {
        ...
        if (smartWalletFeatureEnabled) dispatch(patchHistorySentSignedTransactionsAction());
      } else {
        api.init();
      }
